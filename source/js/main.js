const  section = document.querySelectorAll("section"),
	     ...
	     pointActive = "navigation__item--active";
...
const scrollBtn = anim(".basics", 1000);
down.addEventListener("click", scrollBtn);
//END
...
} else {point[2].classList.add(pointActive);}
}
//END
...
const start = () => input.classList.add("slider__input--active"),
      end = () => input.classList.remove("slider__input--active");
